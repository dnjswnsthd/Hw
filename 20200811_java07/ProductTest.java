	...
	public static void main(String[] args) throws IOException {
		...
		loop:while(true) {
			...
			case(1) : {
				...
				mgr.getAl().add(new TV(st.nextToken(), st.nextToken(), Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()), st.nextToken()));
			...
			case(2) :{
				...
				st = new StringTokenizer(br.readLine());
				mgr.getAl().add(new Refrigerator(st.nextToken(), st.nextToken(), Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken()), Integer.parseInt(st.nextToken())));
				System.out.println("추가 되었습니다.");
				break;
			}
			case(3) :{
