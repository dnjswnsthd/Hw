...
import com.ssafy.java.day11.hw.DuplicateException;
import com.ssafy.java.day11.hw.ProductNotFoundException;
import com.ssafy.java.day11.hw.QuantityException;
import com.ssafy.java.day11.hw.SerialNotFoundException;
...
public class ProductTest {
	public static void main(String[] args) throws IOException {
		...
		loop: while (true) {
			...
			System.out.println("15. 상품 정보 데이터 서버로 보내기 ");
			System.out.println("16. .dat파일에 저장");
			System.out.println("17. .dat파일에 저장된 것 출력");
			...
			case (1): {
				...
				try {
					mgr.add(new TV(st.nextToken(), st.nextToken(), Integer.parseInt(st.nextToken()),
			...
			case (2): {
				...
				st = new StringTokenizer(br.readLine());
				try {
					mgr.add(new Refrigerator(st.nextToken(), st.nextToken(), Integer.parseInt(st.nextToken()),
			...
			case (17): {
				System.out.println(" ======= Electro Mart 재고 관리 시스템 ======= ");
				System.out.println("17. .dat파일에 저장된것 출력");
				mgr.read();
				break;
			}
			case (18): {
